// lib/presentation/widgets/vald_flow_widgets/testing_widget.dart - FIXED OVERFLOW & RESPONSIVE
import 'dart:async';
...
class _TestingWidgetState extends State<TestingWidget>
        ...
        return SingleChildScrollView( // ✅ FIXED: Added scroll capability
          ...
          child: Column(
            children: [
              ...
              // Main Content - ✅ FIXED: Made responsive
              LayoutBuilder(
                builder: (context, constraints) {
                  // ✅ FIXED: Stack layout for smaller screens
                  if (constraints.maxWidth < 800) {
                    return Column(
                      children: [
                        // Charts Panel (full width on small screens)
                        SizedBox(
                          height: 300, // ✅ FIXED: Fixed height
                        ...
                        SizedBox(
                          height: 400, // ✅ FIXED: Fixed height
                          child: _buildMetricsPanel(),
                        ),
                      ],
                    );
                  } else {
                    // ✅ FIXED: Side-by-side layout for larger screens
                    return SizedBox(
                      height: 450, // ✅ FIXED: Fixed height to prevent overflow
                      child: Row(
                        children: [
                          // Left Panel - Charts
                          Expanded(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            blurRadius: 6, // ✅ FIXED: Reduced blur
            offset: const Offset(0, 2),
          ),
        ],
      ),
      child: Column( // ✅ FIXED: Changed to Column for better mobile layout
        children: [
          Row(
            children: [
              // Test Type Icon
          ...
          const SizedBox(height: 8), // ✅ FIXED: Added spacing
          
          // Body weight info (moved to separate row for better layout)
          Container(
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Transform.scale(
          ...
          child: Container(
            padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6), // ✅ FIXED: Reduced padding
            decoration: BoxDecoration(
            ...
            child: Row(
              ...
              children: [
                Icon(statusIcon, color: statusColor, size: 14), // ✅ FIXED: Smaller icon
  ...
  Widget _buildChartsPanel() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Chart Header - ✅ FIXED: More compact
          Row(
            children: [
              const Icon(
                Icons.show_chart,
              ...
              const SizedBox(width: 6), // ✅ FIXED: Reduced spacing
              const Expanded( // ✅ FIXED: Wrapped in Expanded
                child: Text(
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8), // ✅ FIXED: Reduced spacing
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: const TextStyle(
                        fontSize: 32, // ✅ FIXED: Smaller font
                        fontWeight: FontWeight.bold,
                        color: Color(0xFF1565C0),
                      ),
                    ),
      ...
      LineChartData(
        gridData: FlGridData(
          ...
          getDrawingVerticalLine: (value) => FlLine(
            color: Colors.grey.withOpacity(0.2), // ✅ FIXED: More subtle grid
            strokeWidth: 0.5, // ✅ FIXED: Thinner lines
          ),
        ...
        titlesData: FlTitlesData(
          leftTitles: AxisTitles(
            sideTitles: SideTitles(
              showTitles: true,
              reservedSize: 50, // ✅ FIXED: Reduced reserved size
              interval: 500,
              getTitlesWidget: (value, meta) => Text(
                '${(value / 1000).toStringAsFixed(1)}k', // ✅ FIXED: Shorter format
                style: const TextStyle(fontSize: 10, color: Colors.grey), // ✅ FIXED: Smaller font
              ),
            ),
          ),
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              showTitles: true,
              reservedSize: 25, // ✅ FIXED: Reduced reserved size
              interval: 1,
              getTitlesWidget: (value, meta) => Text(
                '${value.toInt()}s',
                style: const TextStyle(fontSize: 10, color: Colors.grey), // ✅ FIXED: Smaller font
        ...
        borderData: FlBorderData(
          show: true,
          border: Border.all(color: Colors.grey.withOpacity(0.2)), // ✅ FIXED: More subtle border
        ),
        lineBarsData: [
          ...
          LineChartBarData(
            ...
            color: Colors.green,
            barWidth: 1.5, // ✅ FIXED: Thinner line
            dotData: const FlDotData(show: false),
  ...
  Widget _buildLegendItem(String label, Color color) {
    return Row(
      ...
      children: [
        Container(
          width: 8, // ✅ FIXED: Smaller legend indicator
          height: 2,
          decoration: BoxDecoration(
            color: color,
        ...
        const SizedBox(width: 3), // ✅ FIXED: Reduced spacing
        Text(
          label,
          style: const TextStyle(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ✅ FIXED: More compact metrics layout
                      Expanded(
                        child: ListView(
                          children: [
                            // Jump Height
  ...
  Widget _buildMetricCard(String title, String value, IconData icon, Color color) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: color, size: 16), // ✅ FIXED: Smaller icon
          const SizedBox(width: 8), // ✅ FIXED: Reduced spacing
          Expanded( // ✅ FIXED: Wrapped in Expanded
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Container(
      ...
      child: Column( // ✅ FIXED: Changed to Column for better mobile layout
        children: [
          ...
          // Start/Stop Button
          SizedBox(
            width: double.infinity, // ✅ FIXED: Full width button

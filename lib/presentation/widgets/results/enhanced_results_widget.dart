...
class _EnhancedResultsWidgetState extends State<EnhancedResultsWidget>
  ...
  Widget _buildResultsHeader() {
    final protocol = EnhancedTestProtocols.protocols[widget.testResult.testType]!;
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.showTurkish ? protocol.turkishName : protocol.name,
  ...
  void _shareResults() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(widget.showTurkish ? 'Sonuçlar paylaşıldı' : 'Results shared'),
        backgroundColor: TestConstants.successGreen,
      ),
    );
  }
  ...
  void _exportResults() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(widget.showTurkish ? 'Sonuçlar dışa aktarıldı' : 'Results exported'),
        backgroundColor: TestConstants.primaryBlue,
      ),
    );
  }
  ...
  void _printResults() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(widget.showTurkish ? 'Sonuçlar yazdırıldı' : 'Results printed'),
        backgroundColor: TestConstants.warningOrange,
      ),
    );
  }
  ...
  void _compareResults() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(widget.showTurkish ? 'Karşılaştırma özelliği yakında' : 'Compare feature coming soon'),
      ),
    );
  }
  ...
  void _saveResults() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(widget.showTurkish ? 'Sonuçlar kaydedildi' : 'Results saved'),
        backgroundColor: TestConstants.successGreen,
      ),
    );
  }
